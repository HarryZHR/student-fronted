<template>
  <div>
    ...
    <div>
      <div class="text-left margin-bottom-20">
        <el-input class="width-200 margin-right-20" v-model="inputStudentNo" placeholder="学号"></el-input>
      ...
      <el-table :data="students" stripe style="width: 100%">
        <el-table-column align="center" prop="studentNo" label="学号" width="180">
        </el-table-column>
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <router-link :to="`/student/${scope.row.studentId}/view`" style="color: #33aaff;">查看</router-link>
            <router-link :to="`/student/${scope.row.studentId}/edit`" style="color: #33aaff;">编辑</router-link>
          </template>
        </el-table-column>
      </el-table>
